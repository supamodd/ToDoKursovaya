...
namespace ToDoListGUI 
{
    ...
    {
    public:
        MainForm(String^ username, bool darkMode)
        {
            ...
            ApplyTheme(currentDarkMode);   // ← сразу применяем тему
        }
    protected:
        /// <summary>
...
#pragma region Windows Form Designer generated code
           ...
           void InitializeComponent(void)
           {
               ...
               this->btnLogout->Location = System::Drawing::Point(660, 595);
